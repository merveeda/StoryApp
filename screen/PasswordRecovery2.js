...
export default class PasswordRecovery2  extends Component {
    ...
    render() {
      ...
      return (
        ...
        <TextInput editable = {true} maxLength = {11} style={styles.phoneInput} placeholder=" _ _ _ _" placeholderTextColor = "#FFFFFF"></TextInput>
        <TouchableOpacity style={styles.btnSend} onPress={() => navigate('PassReco3')}>
